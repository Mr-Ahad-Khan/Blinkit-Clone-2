const products = [
  {
    ...
    details:
      "These premium apples are crisp, naturally sweet, and perfect for daily snacking, fruit salads, juices, and desserts.",
    amount: 120,
    quantity: "1 kg",
  ...
  },
  {
    ...
    details:
      "Organic bananas are rich in energy and make a healthy choice for breakfast, smoothies, and everyday snacking.",
    amount: 60,
    quantity: "1 dozen",
    category: "Fresh Fruits",
    rating: 4.7,
  ...
  },
  {
    ...
    details:
      "Fresh oranges are juicy, refreshing, and loaded with citrus flavor for juices, salads, and healthy snacks.",
    amount: 90,
    quantity: "1 kg",
    category: "Fresh Fruits",
    rating: 4.6,
  ...
  },
  {
    ...
    details:
      "Green grapes are fresh, crunchy, and sweet. They are ideal for quick snacks, lunch boxes, and fruit bowls.",
    amount: 140,
    quantity: "500 g",
    category: "Fresh Fruits",
    rating: 4.5,
